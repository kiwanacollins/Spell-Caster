  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        incantation: ['1.5rem', { lineHeight: '2rem', letterSpacing: '0.025em' }],
        prophecy: ['2rem', { lineHeight: '2.5rem', letterSpacing: '0.015em' }],
        ancient: ['3rem', { lineHeight: '3.5rem', letterSpacing: '0.01em', fontWeight: '700' }],
      },
      borderRadius: {
        ritual: '0.25rem',
        scroll: '0.5rem',
      ...
      boxShadow: {
        ...
        'parchment-hover': '0 4px 12px rgba(0, 0, 0, 0.15), 0 8px 24px rgba(0, 0, 0, 0.1)',
      ...
      backgroundImage: {
        ...
        'ancient-gradient': 'linear-gradient(135deg, #4a1f5e 0%, #2d1240 50%, #1c1c1e 100%)',
